...
namespace CitizenHackathon2025.Application.Interfaces
{
    public interface ICrowdInfoService
    {
        ...
        Task<ManualCriticalAlertResultDTO> CreateManualCriticalAlertAsync(CitizenHackathon2025.Contracts.DTOs.ManualCrowdCriticalAlertRequest request, CancellationToken ct = default);
